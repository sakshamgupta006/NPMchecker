...
declare namespace fakes {
    ...
    type ExpectedDiagnostic = [ts.DiagnosticMessage, ...(string | number)[]];
    const version = "FakeTSVersion";
...
declare namespace Harness.SourceMapRecorder {
    ...
    function getSourceMapRecordWithVFS(fs: vfs.FileSystem, sourceMapFile: string): string;
}
...
declare namespace FourSlashInterface {
    ...
    namespace Completion {
        ...
        const globalsInJs: ReadonlyArray<ExpectedCompletionEntryObject>;
        function globalsPlus(plus: ReadonlyArray<ExpectedCompletionEntry>): ReadonlyArray<ExpectedCompletionEntry>;
        function globalsInJsPlus(plus: ReadonlyArray<ExpectedCompletionEntry>): ReadonlyArray<ExpectedCompletionEntry>;
    }
