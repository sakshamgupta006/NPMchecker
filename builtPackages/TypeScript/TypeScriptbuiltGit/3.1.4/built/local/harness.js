...
(function (fakes) {
    ...
    var SolutionBuilderHost = /** @class */ (function (_super) {
        ...
        SolutionBuilderHost.prototype.assertDiagnosticMessages = function () {
            ...
            var actual = this.diagnostics.slice();
            if (actual.length !== expected.length) {
                assert.fail(actual, expected, "Diagnostic arrays did not match - got\r\n" + actual.map(function (a) { return "  " + a.messageText; }).join("\r\n") + "\r\nexpected\r\n" + expected.map(function (e) { return "  " + e.message; }).join("\r\n"));
            }
    ...
    (function (Compiler) {
        ...
        function optionValue(option, value, errors) {
            switch (option.type) {
                ...
                case "list":
                    return ts.parseListTypeOption(option, value, errors); // tslint:disable-line no-unnecessary-type-assertion
                default:
...
(function (FourSlash) {
    ...
    function runCode(code, state) {
        ...
        var wrappedCode = "(function(test, goTo, plugins, verify, edit, debug, format, cancellation, classification, verifyOperationIsCancelled) {\n" + code + "\n})";
        try {
            ...
            f(test_1, goTo, plugins, verify, edit, debug, format, cancellation, FourSlashInterface.Classification, verifyOperationIsCancelled);
        }
        catch (err) {
            throw err;
        }
