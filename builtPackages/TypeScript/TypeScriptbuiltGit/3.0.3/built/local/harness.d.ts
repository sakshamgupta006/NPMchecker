...
declare namespace fakes {
    ...
    class SolutionBuilderHost extends CompilerHost implements ts.SolutionBuilderHost {
        ...
        assertDiagnosticMessages(...expected: ts.DiagnosticMessage[]): void;
...
declare namespace FourSlash {
    ...
    class TestState {
        ...
        setCancelled(numberOfCalls: number): void;
        resetCancelled(): void;
        getEditsForFileRename({ oldPath, newPath, newFileContents }: FourSlashInterface.GetEditsForFileRenameOptions): void;
