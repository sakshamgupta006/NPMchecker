...
(function (FourSlash) {
    ...
    var TestState = /** @class */ (function () {
        ...
        TestState.prototype.verifyRefactorsAvailable = function (names) {
            assert.deepEqual(unique(this.getApplicableRefactors(this.getSelection()), function (r) { return r.name; }), names);
        };
        ...
        TestState.prototype.moveToNewFile = function (options) {
            ...
            var editInfo = this.languageService.getEditsForRefactor(this.activeFile.fileName, this.formatCodeSettings, range, refactor.name, action.name, options.preferences || ts.emptyOptions);
        ...
        TestState.prototype.verifyFileAfterApplyingRefactorAtMarker = function (markerName, expectedContent, refactorNameToApply, actionName, formattingOptions) {
            ...
            var applicableRefactors = this.languageService.getApplicableRefactors(this.activeFile.fileName, markerPos, ts.emptyOptions);
            ...
            var editInfo = this.languageService.getEditsForRefactor(this.activeFile.fileName, formattingOptions, markerPos, refactorNameToApply, actionName, ts.emptyOptions);
        ...
        TestState.prototype.getEditsForFileRename = function (_a) {
            var _this = this;
            var oldPath = _a.oldPath, newPath = _a.newPath, newFileContents = _a.newFileContents;
            var test = function (fileContents, description) {
                var changes = _this.languageService.getEditsForFileRename(oldPath, newPath, _this.formatCodeSettings, ts.emptyOptions);
