...
declare namespace ts {
    ...
    function getOptionDeclarationFromName(getOptionNameMap: () => OptionNameMap, optionName: string, allowShort?: boolean): CommandLineOption | undefined;
...
declare namespace ts {
     ...
     */
    function createSolutionBuilder(host: SolutionBuilderHost, rootNames: ReadonlyArray<string>, defaultOptions: BuildOptions): {
...
declare namespace ts.server.typingsInstaller {
    ...
    abstract class TypingsInstaller {
        ...
        private readonly globalCacheCanonicalPackageJsonPath;
