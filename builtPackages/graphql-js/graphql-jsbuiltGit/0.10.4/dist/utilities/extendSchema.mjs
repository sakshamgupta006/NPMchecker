...
export function extendSchema(schema, documentAST, options) {
  ...
  for (var _i = 0, _schemaExtensions = schemaExtensions; _i < _schemaExtensions.length; _i++) {
    var schemaExtension = _schemaExtensions[_i];
  ...
  function extendInputFieldMap(type) {
    ...
    for (var _i2 = 0, _Object$keys = Object.keys(oldFieldMap); _i2 < _Object$keys.length; _i2++) {
      var _fieldName = _Object$keys[_i2];
  ...
  function extendValueMap(type) {
    ...
    for (var _i3 = 0, _Object$keys2 = Object.keys(oldValueMap); _i3 < _Object$keys2.length; _i3++) {
      var _valueName = _Object$keys2[_i3];
  ...
  function extendFieldMap(type) {
    ...
    for (var _i4 = 0, _Object$keys3 = Object.keys(oldFieldMap); _i4 < _Object$keys3.length; _i4++) {
      var _fieldName2 = _Object$keys3[_i4];
