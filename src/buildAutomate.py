...
with open("assets/npmGithubUrl.json", "r") as main_file:
    ...
    for ind, val in enumerate(mainFile):
        packName = mainFile[ind]["packageName"]
...
packageList = ['lodash', 'react', 'underscore', 'prop-types', 'jquery', 'vue', 'axios', 'babel-loader', 'core-js', 'winston', 'css-loader', 'ember-cli-babel', 'redux', 'style-loader', 'superagent', 'file-loader', 'typescript', 'ramda', 'node-fetch', 'url-loader', 'node-sass', 'marked', 'extract-text-webpack-plugin', 'immutable', 'babel-preset-env', 'es6-promise', 'underscore.string', 'vue-router', 'eslint-plugin-jsx-a11y', 'jest', 'reflect-metadata', 'ember-cli-htmlbars', 'validator', 'babel-jest', 'styled-components', 'redux-thunk', 'eslint-plugin-flowtype', 'deepmerge', 'got', 'source-map-support', 'less-loader', 'history', 'crypto-js', 'graphql', 'ajv', 'shortid', 'vuex', 'sinon', 'babel-plugin-transform-decorators-legacy', 'backbone', 'prettier', 'webpack-merge', 'escodegen', 'nunjucks', 'cross-env', 'puppeteer', 'uglifyjs-webpack-plugin', 'should', 'vue-template-compiler', 'bignumber.js', 'github', 'ioredis', 'copy-webpack-plugin', 'rsvp', 'acorn', 'firebase', 'knex', 'popper.js', 'babylon', 'systemjs', 'ts-loader', 'redux-logger', 'rollup', 'global', 'karma', 'babel-plugin-add-module-exports', 'http-proxy-middleware', 'raw-loader', 'hammerjs', 'jshint', 'json5', 'mini-css-extract-plugin', 'bcryptjs', 'async-validator', 'webpack-cli', 'ts-node', 'codemirror', 'xlsx', 'protobufjs', 'leaflet', 'clean-webpack-plugin', 'jimp', 'three', 'eslint-plugin-node', 'redux-actions', 'faker', 'webpack-bundle-analyzer', 'rollup-plugin-node-resolve', 'sync-request', 'es6-promisify', 'throttle-debounce', 'unist-util-visit', 'rollup-plugin-commonjs', 'enzyme', 'he', 'node-forge', 'draft-js', 'mathjs', 'is-plain-object', 'cuid', 'ethereumjs-util', 'lodash-es', 'crc', 'node-cache', 'babel-plugin-import', 'redux-form', 'recast', 'vue-hot-reload-api', 'flux', 'file-saver', 'phantom', 'i18next', 'xregexp', 'rollup-plugin-babel', 'promise-polyfill', 'long', 'gulp-shell', 'pouchdb', 'soap', 'bson', 'utf8', 'resize-observer-polyfill', 'rollup-pluginutils', 'rc-util', 'lowdb', 'tweetnacl', 'babel-plugin-transform-react-remove-prop-types', 'pngjs', 'isobject', 'radium', 'clipboard', 'localforage', 'es6-error', 'preact', 'vue-resource', 'immutability-helper', 'react-error-overlay', 'angular-ui-router', 'tslint-react', 'husky', 'ts-jest', 'hexlet-pairs', 'bytebuffer', 'rc-slider', 'ua-parser-js', 'awesome-typescript-loader', 'object.assign', 'dom-helpers', 'raven', 'sanitize-html', 'intl', 'postcss-preset-env', 'blueimp-md5', 'base64-js', 'big.js', 'karma-webpack', 'toml', 'common-tags', 'bitcoinjs-lib', 'ignore', 'babel-plugin-named-asset-import', 'react-onclickoutside']
...
for package in packageList:
    ...
    with open("assets/npmGithubUrl.json", "r") as main_file:
        mainFile = json.load(main_file)
        for ind, val in enumerate(mainFile):
            package = mainFile[ind]["packageName"]
            #get the version from npm registry
            repoName = ""
            owner = ""
            githubUrl = ""
